...
ugly_plot <- ggplot(data = space_dogs_summarized, 
  ...
  theme(
    plot.background = element_rect(fill = "pink", color = "red", size = 9),
    panel.grid.major = element_line(color = "yellow", linetype = "dotted", size = 6),
    axis.text.x = element_text(angle = 90,  color = "blue", face = "bold"),
